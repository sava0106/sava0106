...
const music = new Audio("../assets/sounds/lort.mp3");
      music.loop = true;
      music.volume = 0.5;
...
const birdImage = new Image(90, 90);
      birdImage.src = "../assets/images/bodybuilder.png";
...
const scoreImage = new Image(60, 60);
      scoreImage.src = "../assets/images/salathoved.jpeg";
...
const fireballImage = new Image(350, 350);
      fireballImage.src = "../assets/images/slik.jpeg";
...
// coin variables
const coinSound = new Audio("../assets/sounds/salathoved.jpeg");
...
const diamondImage = new Image(60, 60);
      diamondImage.src = "../assets/images/bøf.jpeg";
